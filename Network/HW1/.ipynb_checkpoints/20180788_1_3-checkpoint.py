...
def server(interface, port):
    ...
    while attempt < 5:
        ...
        #print('  Incoming sixteen-octet message:', message, type(message))
...
def client(host, port):
    ...
    while attempt < 5:
        guess = input("input>> ")
        #print("guess : {} , type = {}".format(guess.encode(), type(guess.encode())))
        ...
        if reply.decode() == 'Congratulations you did it':
            ...
            print(reply.decode())
        #print('The server said {} , type : {}'.format(reply, type(reply)))
        attempt += 1
        #print("attempt : {}".format(attempt))
    sock.close()
